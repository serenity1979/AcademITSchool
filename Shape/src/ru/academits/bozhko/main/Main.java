...
public class Main {
    public static void main(String[] args) {
        ...
        int orderIndex = 2;
        Shape figureMaxPerimeter = foundOrderMaxPerimeter(orderIndex, myShapes);
        ...
        if (myShapes[4].hashCode() == myShapes[8].hashCode()) {
            System.out.printf("у фигур %s и %s - одинаковый HashCode. %n", myShapes[4].toString(), myShapes[8].toString());
        } else {
            System.out.printf("У Фигур %s и %s - разный Hashcode. %n", myShapes[4].toString(), myShapes[8].toString());
        }
    }

    private static Shape foundMaxArea(Shape... listShapes) {
    ...
    private static Shape foundOrderMaxPerimeter(int signOrderIndex, Shape... listShapes) {
        int arrayLength = listShapes.length;
